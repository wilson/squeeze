...
class TestSqueezeHtmlClient(unittest.TestCase):
    ...
    def test_get_html(self, mock_urlopen):
        ...
        mock_urlopen.assert_called_with("http://example.com:9000/status.html?player=00:11:22:33:44:55")
        
    @patch("squeeze.html_client.SqueezeHtmlClient.get_html")
    def test_get_players(self, mock_get_html):
    ...
    def test_send_command(self, mock_urlopen):
        ...
        mock_urlopen.assert_called_with("http://example.com:9000/status.html?player=00:11:22:33:44:55&p0=play")
        
        # Test with params
        client.send_command("00:11:22:33:44:55", "mixer", ["volume", "50"])
        mock_urlopen.assert_called_with("http://example.com:9000/status.html?player=00:11:22:33:44:55&p0=mixer&p1=volume&p2=50")
